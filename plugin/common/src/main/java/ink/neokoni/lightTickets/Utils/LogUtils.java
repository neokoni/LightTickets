...
public final class LogUtils {
    ...
    public static void info(String key) {
        LightPlatformProvider.get().getLogger().info(LangUtils.getRawLang(key));
    }

    public static void info(String key, Map<String, String> placeholders) {
        LightPlatformProvider.get().getLogger().info(LangUtils.getRawLang(key, placeholders));
    }

    public static void warning(String key) {
        LightPlatformProvider.get().getLogger().warning(LangUtils.getRawLang(key));
    }

    public static void warning(String key, Map<String, String> placeholders) {
        LightPlatformProvider.get().getLogger().warning(LangUtils.getRawLang(key, placeholders));
    }

    public static void severe(String key, Map<String, String> placeholders) {
        LightPlatformProvider.get().getLogger().severe(LangUtils.getRawLang(key, placeholders));
    }
